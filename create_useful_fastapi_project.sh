...
touch $PROJECT_NAME/{app/{__init__.py,main.py,models.py,services.py,logging_config.py,routers/__init__.py,routers/place_holder_file.py,db/__init__.py,db/session.py,core/__init__.py,core/config.py},tests/{__init__.py,test_place_holder_file.py},alembic/{env.py,script.py.mako},alembic.ini,README.md,.gitignore}
